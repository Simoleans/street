                            ...
                            <div class="col-lg-6 col-md-12 px-4 pt-3 bg-white">
                              ...
                              <p class="card-text mb-3">
                                ...
                                <form action="{{route('user.store')}}" method="POST">
                                  ...
                                  <input type="text" class="form-control mb-3 error" placeholder="Nombre" required="" name="name" />
                                  <input type="text" class="form-control mb-3 error" placeholder="Apellido" required="" name="lastname" />
