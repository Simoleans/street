          ...
          <div class="navbar-container">
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic2" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-bell font-medium-3 blue-grey darken-4"></i><span class="notification badge badge-pill badge-danger">{{count($convocatoria)}}</span>
                    <p class="d-none">Notifications</p></a>
                  <div class="notification-dropdown dropdown-menu dropdown-menu-right">
                    <div class="noti-list">
                      @foreach($convocatoria as $c)
                      <a href="{{route('convocatoria.show',['id' => $c->id])}}" class="dropdown-item noti-container py-3 border-bottom border-bottom-blue-grey border-bottom-lighten-4"><i class="ft-bell info float-left d-block font-large-1 mt-1 mr-2"></i><span class="noti-wrapper"><span class="noti-title line-height-1 d-block text-bold-400 info">{{strtoupper($c->titulo)}}</span><span class="noti-text">{{$c->fecha}}</span></span></a>
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                  ...
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right">
                    ...
                    <a href="{{route('user.show',['id' => Auth::user()->id])}}" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span> Perfil</span></a>
                    <a href="#" class="dropdown-item py-1"><i class="ft-credit-card"></i><span> Pagos</span></a>
